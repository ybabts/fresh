...
import LemonDropHome from "../islands/LemonDropHome.tsx";
...
function Hero(props: { origin: string }) {
  return (
    <>
      <section class="w-full flex items-start flex-col bg-green-300">
        <div class="max-w-screen-xl mx-auto sm:my-8 md:my-16 px(4 sm:6 md:8) sm:space-y-12 w-full">
